...
class GCN(torch.nn.Module):
    def __init__(self, data, writer, dropout=0):
        ...
        self.conv1 = GCNConv(self.num_features, 30)

        self.pconv1 = GCNConv(30, 32)
        self.pool1 = DIFFPool()

        self.pconv2 = GCNConv(30, 4)
        self.pool2 = DIFFPool()
